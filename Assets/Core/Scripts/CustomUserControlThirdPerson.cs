...
/// </summary>
public class CustomUserControlThirdPerson : RootMotion.Demos.UserControlThirdPerson {
    ...
    protected override void Update ()
    {
        ...
        Vector3 move = Quaternion.identity * new Vector3(h, 0f, v).normalized;
        ...
        state.lookPos = transform.position + Vector3.forward * 100f;
    }
}